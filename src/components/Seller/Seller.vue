  ...
  <div class="flex gap-5 mt-36 max-lg:flex-col-reverse text-center">
    <div class="w-full max-lg:w-full">
      ...
      <p class="leading-8 text-xl my-5">
        ...
        dignissimos asperiores dolores nostrum aspernatur ex unde accusantium
        reprehenderit iste explicabo! Assumenda, sunt sequi! Accusamus
        laudantium unde voluptatem adipisci facere ex necessitatibus nisi
        eligendi repellendus minima et incidunt eaque, blanditiis, aliquid nobis
